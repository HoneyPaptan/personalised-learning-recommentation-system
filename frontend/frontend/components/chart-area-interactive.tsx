...
export function ChartAreaInteractive({ chartData = [] }: { chartData?: { created_at: string, mastery_h: number }[] }) {
  ...
  const formattedData = React.useMemo(() => {
    ...
    return chartData
      .map((item) => ({ 
        ...
        mastery: Math.round(item.mastery_h * 100) 
      }))
